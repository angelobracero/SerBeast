...
function App() {
  ...
  return (
    <>
      <header className="fixed top-0 w-screen bg-lightblue text-gray-200 h-16 border-b-2 border-lightgreen">
        <div className="flex items-center h-full w-[90%] md:w-[80%] mx-auto">
          ...
          <div className="flex space-x-3 ml-auto">
            ...
            {isOpen ? (
              <IoCloseOutline
                className="h-7 w-7 scale-125 md:hover:text-white cursor-pointer md:hidden"
                onClick={toggleMenu}
              />
            ) : (
              <RxHamburgerMenu
